...
def test(model, test_loader, criterion):
    '''
    Complete this function that can take a model and a testing data loader 
...
def train(model, dataloaders, criterion, optimizer, scheduler, dataset_sizes):
    ...
    print('Best valid Accủacy: {:4f}'.format(best_acc))
...
def main(args):
    ...
    Remember to set up a way to get training data from S3
    '''
...
if __name__=='__main__':
    ...
    parser.add_argument("--lr", 
                        type=float, default=0.0005, metavar="LR", 
